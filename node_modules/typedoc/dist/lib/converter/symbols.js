...
function convertVariable(context, symbol, nameOverride) {
    ...
    if (ts.isVariableDeclaration(declaration) &&
        enum_1.hasFlag(symbol.flags, ts.SymbolFlags.BlockScopedVariable)) {
...
function convertVariableAsFunction(context, symbol, nameOverride) {
    ...
    if (declaration &&
        enum_1.hasFlag(symbol.flags, ts.SymbolFlags.BlockScopedVariable)) {
        reflection.setFlag(models_1.ReflectionFlag.Const, enum_1.hasFlag((declaration || symbol.valueDeclaration).parent.flags, ts.NodeFlags.Const));
    }
    const reflectionContext = context.withScope(reflection);
