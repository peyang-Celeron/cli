...
let CommentPlugin = CommentPlugin_1 = class CommentPlugin extends components_1.ConverterComponent {
    ...
    onBeginResolve(context) {
        ...
        const [allRemoved, someRemoved] = lodash_1.partition(hidden
            ...
            .filter((method) => method.kindOf(index_2.ReflectionKind.FunctionOrMethod |
            index_2.ReflectionKind.Constructor)), (method) => { var _a; return ((_a = method.signatures) === null || _a === void 0 ? void 0 : _a.length) === 0; });
