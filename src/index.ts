...
if (hasVerbose) { console.log(chalk.greenBright(figures.tick) + " " + __("All modules have been resolved successfully. " + Timer.prettyTime())); }


export default manager;

if (hasVerbose) { console.log("Exported Module Manager."); }


const main = async () => {
    if (hasVerbose) { console.log(chalk.magentaBright(figures.pointer) + " " + __("Module initialize step:")); }
